...
// cluster_output_ascii

module cluster_output_ascii (
    input  I,
    input  clk,
    input  rst_n,
    input  next_EN,
    ...
    // nets fully internal to this group -- never cross the boundary
    wire n__1420,
         n__1425,
         n__1475,
         n__1516,
...
// cluster_success  (v2 -- whole-cluster nesting)

module cluster_success (
    input  I,
    input  clk,
    input  rst_n,
    input  enable,
    ...
    // nets fully internal to this group
    wire n__1,
         n__1000,
         n__1006,
         n__101,
    ...
    // the 14 whole clusters that feed success 
    ...
    // loose top-level gates (not part of any named cluster) 
...
// JaneStreet (restructured top level)
...
module JaneStreet (
    ...
    cluster_success u_cluster_success (
        .I(I),
        .clk(clk),
        .rst_n(rst_n),
        .enable(enable),
    ...
    cluster_output_ascii u_cluster_output_ascii (
        .I(I),
        .clk(clk),
        .rst_n(rst_n),
        .next_EN(next_EN),
    ...
    cluster_bridge u_cluster_bridge (
        .clk(clk),
        .rst_n(rst_n),
        .n__1351(n__1351),
        .n__1363(n__1363),
